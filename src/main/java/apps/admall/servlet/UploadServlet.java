...
public class UploadServlet extends HttpServlet {
    ...
    private String getDefaultAdmitConfig() {
        return "{\n" +
               "  \"admitCard\": {\n" +
               "    \"title\": \"Admit Card for PhD. Entrance Examination for Category-2 at Academic Portal\\n(Session: July 2025)\",\n" +
               "    \"fields\": [\n" +
               ...
               "      \"venue\": \"National Institute of Technical Teachers' Training & Research, Shamla Hills, Science Centre Road, Bhopal-462002\"\n" +
               "    },\n" +
               "    \"instructions\": [\n" +
